...
earnings_calendar_status ('ok'|'empty'|'failed') come from Finnhub — real,
structured data, not model-generated. earnings_calendar.{TICKER} may include
next_report (date_label, fiscal_period_label) and/or latest_result
(report_date_label, eps_actual, eps_estimate, beat).
...
NEWS (CRITICAL)
news_sources[] and news_enrichment ('skipped'|'ok'|'empty'|'failed') come
from Finnhub — real, structured headlines per ticker (title, snippet, url,
source, published_at), not free-text generated by the model.
