...
BUDGET (CRITICAL)
- If has_budget is false, ask for a budget in QaAnswerText before any
...
- concentration_warning=true → add QaTipBanner (tone=warning) about sector
  concentration; mention overweight_sector if present.
...
3. QaTipBanner (optional; use tone=warning when concentration_warning)
